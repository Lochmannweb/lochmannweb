...
function ContactForm() {
  ...
  <section style={classes.container}>
    <div style={classes.leftContainer}>
      <h1 style={classes.leftContainerTitle} >LET&apos;S <br /> <span className='text-7xl font-serif'>ACHIEVE YOUR</span><br /> VISION</h1> 
    </div>

    <div>
    <div style={classes.rightBGContainer}>
      <h1 className='text-5xl mb-8'>{ContactFormularData.title}</h1>
  
      <div style={classes.formAndContactOplysninger}> 
        <form 
          onSubmit={handleSubmit}>
    
          <div style={classes.formContainers}>
          ...
          <div>
            <button type="submit" style={classes.sendButton} disabled={state.submitting}>
              {ContactFormularData.button}
            </button>
          </div>
        </form>   
    
        <div style={classes.contactOplysninger}>
